...
#https://www.youtube.com/watch?v=H3w4lOFBUOI&list=PLyZB5ywlnsu81uJdbY8QGcxlRqwB3LBLc&index=1&ab_channel=freeCodeCampConcepts
...
try:
    row = cur.fetchone()
    start = 0 if row is None else row[0]
except:
    start = 0
